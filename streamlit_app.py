...
# --- HARİTA VE ARAMA ---
    ...
    # Mobil uyumlu üstbilgi ve çıkış butonu yan yana
    ust_col1, ust_col2 = st.columns([3, 1])
    with ust_col1:
    ...
    # Form kullanarak arama alanı (Telefonda alt alta düzenli durur)
    ...
    # Folium Haritasını Oluştur (Genişliği telefona tam oturması için 100% ayarlı)
    m = folium.Map(
    ...
    # Haritayı ekrana bas (width='100%' ile telefonda ekranı tamamen doldurur)

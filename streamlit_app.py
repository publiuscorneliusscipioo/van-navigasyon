...
# Excel Dosyası Yükleme (ana dizinde)
@st.cache_data
def veri_yukle():
    yol = "Tesisatlar.xlsx"
...
# --- HARİTA VE ARAMA EKRANI ---
    ...
    # Harita her zaman girişten sonra hazır
    if df is None or df.empty:
        st.error("⚠️ Tesisatlar.xlsx dosyası bulunamadı! Lütfen ana dizine yükleyin.")
    else:
        # Varsayılan harita (Van merkez koordinatları örnek)
        m = folium.Map(location=[38.5, 43.4], zoom_start=12)

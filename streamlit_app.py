...
# --- 2. DEMO / ROTA PLANLAMA PANELİ (SOL: PANEL, SAĞ: HARİTA) ---
    ...
    # Düzen: Sol tarafta yükleme ve havuz kutusu, sağ tarafta geniş harita
    col_sag_panel, col_sol_harita = st.columns([3, 7])
    ...
    with col_sag_panel:
        ...
        if st.session_state.demo_secilenler:
            ...
            # Excel'e İndir Butonu (openpyxl motoru kullanılarak hata engellendi)
    ...
    with col_sol_harita:
        ...
        # Haritada tıklanan koordinatı yüklenen tesisatlarla eşleştirip sol havuza atma
